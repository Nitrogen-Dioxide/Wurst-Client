...
public class FightBotMod extends Mod implements UpdateListener {
	...
	public void onUpdate() {
		KillauraMod killaura = (KillauraMod) WurstClient.INSTANCE.modManager
		...
		double xDist = Math.abs(Minecraft.getMinecraft().thePlayer.posX
				- entity.posX);
		double zDist = Math.abs(Minecraft.getMinecraft().thePlayer.posZ
				- entity.posZ);
